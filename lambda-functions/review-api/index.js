...
async function saveReviewToFirestore(reviewData) {
  ...
  const reviewDoc = {
    ...
    tags: {
      behavioral: reviewData.behavioralAnalysis.behavioralTag,
      behavioralScore: reviewData.behavioralAnalysis.score,
      behavioralReasons: reviewData.behavioralAnalysis.reasons,
      linguistic: "pending", // Will be updated by the linguistic analysis Lambda
      finalDecision: "pending", // Will be updated by the linguistic analysis Lambda
    },
    behavioralData: reviewData.behavioralData,
  };
...
exports.handler = async (event) => {
  try {
    ...
    const { reviewText, behavioralData, userId, productId, rating } =
      eventBody || {};
